		...
		<div id="feature-area" class="fset_height">
			...
			<?php
				...
				foreach( $f as $post ) :
						...
						$feature_style = ( ploption( 'feature-style', $oset ) ) ? ploption( 'feature-style', $oset ) : 'text-right';
						...
						//pull media from custom field
						$feature_media = get_post_meta($post->ID, 'Video', true);
									...
									<div class="fcontent scale_text fset_height <?php echo $fcontent_class;?>">
										<div class="fcontent-pad fix">
												<?php
													...
													$content = ( $feature_source == 'posts' || $feature_source == 'posts_all' ) ? apply_filters( 'pagelines_feature_output', custom_trim_excerpt( get_the_content(), '70' ) ) : do_shortcode( get_the_content() );
									...
									<div class="fmedia fset_height" style="">
										<div class="fmedia-pad">
											...
											elseif( $feature_media )
												echo do_shortcode('[pl_video type="youtube" id="'.youtube_id_from_url($feature_media).'"] ');
												//var_dump($feature_media);
												?>
										</div>
									</div>
									<script>
